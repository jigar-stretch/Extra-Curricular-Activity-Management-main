                  ...
                  <div class="col-md-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="button" name="validate" id="validate" onclick="fun_validate_student(<?php echo "student_rollno" . $i; ?>.value,<?php echo "token_key" . $i; ?>.value,<?php echo $i; ?>,'<?php echo $_GET['event_id']; ?>')" value="Verify" class="btn btn-info" >
                          </td>
                          <td>
...
?>
<script>
function fun_validate_student(student_rollno,token_key,ivalue,event_id)
{
    ...
    function(data){
      if(data == "-")
	  {
		  alert("Student already participated for this event..");
		  $('#divstudent'+ivalue).html("<i class='btn btn-danger fa fa fa-thumbs-down fa-lg' aria-hidden='true'> Rejected</i>");
		  $('#student_id'+ivalue).val(0);
		  $('#student_rollno'+ivalue).val('');
		  $('#token_key'+ivalue).val('');
	  }
      else if(data == 0)	  
      {
		  alert("Not valid...");
